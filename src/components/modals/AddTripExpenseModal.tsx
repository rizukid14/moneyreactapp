      ...
      <div className="modal-overlay" onClick={onClose} style={{ zIndex: 1200 }}>
        ...
        >
          ...
          <div style={{ display: 'grid', gap: '20px' }}>
            ...
            <div style={{ background: 'var(--bg-neutral)', borderRadius: '28px', padding: '24px', border: '1px solid var(--border-color)', position: 'relative', overflow: 'hidden' }}>
              <div style={{ position: 'absolute', top: '-50px', left: '-50px', width: '150px', height: '150px', background: 'var(--primary-glow)', filter: 'blur(40px)', borderRadius: '50%', opacity: 0.5 }} />
              
              <div style={{ position: 'relative', zIndex: 1 }}>
                <label style={{ fontSize: '11px', fontWeight: 800, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '8px', display: 'block' }}>Keterangan & Nominal</label>
                <input 
                  type="text" 
                  value={description}
                  ...
                  style={{ 
                    ...
                    fontSize: '18px', fontWeight: 800, color: 'var(--text-main)', 
                    padding: '8px 0', outline: 'none', borderBottom: '1.5px solid var(--border-color)',
                    marginBottom: '16px'
                  }}
                />
                <div style={{ display: 'flex', alignItems: 'flex-end', gap: '8px' }}>
                  <span style={{ fontSize: '24px', fontWeight: 900, color: 'var(--primary)', marginBottom: '4px' }}>{currencySymbol}</span>
                  <input 
                    type="text" 
                    ...
                    style={{ 
                      ...
                      fontSize: '42px', fontWeight: 900, color: 'var(--text-main)', 
                ...
                {trip.members.map(m => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div style={{ flex: 1 }}>
                        <div style={{ fontWeight: 800, fontSize: '14px', color: isIncluded ? 'var(--text-main)' : 'var(--text-muted)' }}>{m.name}</div>
                      </div>
